...
const Download = () => {
  return (
    <section
      id="download"
      className="section-padding bg-gradient-to-b from-secondary/50 to-background dark:from-secondary/20 dark:to-background"
    >
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="heading-lg mb-4">Download EsusuChain Today</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">
            Start your savings journey with EsusuChain and experience secure,
            transparent rotating savings on your mobile device.
          </p>
              ...
              <div className="aspect-video bg-gradient-to-br from-esusu-100/70 to-esusu-50/30 dark:from-esusu-900/30 dark:to-background">
                <div className="flex items-center justify-center h-full">
                  <div className="grid grid-cols-3 gap-4 max-w-2xl p-4">
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg w-full h-80">
                      <img
                        src="/assets/esusu-chain-pool.webp"
                        alt=""
                        className="w-full h-full"
                      ></img>
                    </div>
                    <div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg w-full h-80">
                      <img
                        src="/assets/esusu-chain-payment.webp"
                        alt=""
                        className="w-full h-full"
                      ></img>
                    </div>
